  ...
  return (
    <div className="min-h-screen bg-[#020202] flex items-center justify-center p-6 text-white font-sans overflow-hidden">
      ...
      <div className="w-full max-w-[400px] bg-[#0A0A0A] border border-white/10 rounded-[2.5rem] p-10 text-center shadow-2xl relative z-10">
        {step === 2 && (
          <button onClick={() => setStep(1)} className="absolute top-8 left-8 text-zinc-500 hover:text-white"><ArrowLeft size={20} /></button>
        )}
        ...
        {step === 1 ? (
          ...
          <form onSubmit={handleVerifyOtp} className="space-y-6">
            ...
            <button type="submit" disabled={loading || otp.join('').length < 6} className="w-full bg-blue-600 text-white font-black py-5 rounded-2xl hover:bg-blue-500 transition-all shadow-lg shadow-blue-600/20">
