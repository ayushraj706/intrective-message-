...
const ChatWindow = ({ messages = [], selectedRoom, children }) => {
  ...
  return (
    ...
    <div className="flex flex-col h-full overflow-hidden bg-[#050505] relative">
      ...
      {/* INPUT AREA: Ye hamesha bottom par rahega */}
      <div className="shrink-0 bg-gradient-to-t from-black via-black/80 to-transparent pt-4">
        {children} {/* Yahan ChatInput.js render hoga */}
      </div>
    </div>
  );
};
